...
class Summary extends Component {
  ...
  componentDidMount() {
    this.props.getSummaryDetails(
      this.props.patientDetails.serviceRequestVisitId
    );
  }
  ...
  onClickNext = () => {
    ...
    const data = {
      ...
      OriginalTotalDuration: parseInt(
        this.state.summaryDetails.originalTotalDuration,
        0
      ),
  ...
  render() {
    let modalContent = "";
    let completedTaskPercent = Math.round(
      (this.props.SummaryDetails.totalTaskCompleted /
        this.props.SummaryDetails.totalTask) *
        100
    );
    ...
    if (this.state.isModalOpen) {
      modalContent = (
        <form className="AdjustTimeForm">
          <p className="AdjustTimeText">Time taken to complete the service</p>
        ...
        <div className="ProfileHeaderWidget">
          <div className="ProfileHeaderTitle">
            <h5 className="primaryColor m-0">
              Service Requests{" "}
              <span>/ {this.props.patientDetails.serviceRequestId}</span>
            </h5>
          </div>
        </div>
        <Scrollbars
                    ...
                    <span>
                      <i className="requestName">
                        <Moment format="ddd, DD MMM">
                          {this.props.patientDetails.visitDate}
                        </Moment>
                        , {this.props.patientDetails.slot}
                      </i>
                      {this.props.patientDetails.serviceRequestId}
                    </span>
                  </div>
                  <div className="requestImageContent">
                    {this.props.patientDetails.patient ? (
                      <span>
                        ...
                        />
                        <i className="requestName">
                          {this.props.patientDetails.patient.firstName}{" "}
                          {this.props.patientDetails.patient.lastName &&
                ...
                <div className="col col-md-4 rightTimerWidget running">
                  <div className="row rightTimerContainer">
                    <div className="col-md-5 rightTimerContent FeedbackTimer">
                      <span className="TimerContent running">
                        {this.props.SummaryDetails.originalTotalDuration}
                      </span>
                    </div>
                    <div className="col-md-7 rightTimerContent FeedbackTimer">
                      <span className="TimerStarted running">
                        Started at{" "}
                        {this.props.startedTime && this.props.startedTime}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="ServiceContent">
                <div className="VisitSummaryWidget">
                  <div className="LeftWidget">
                    <div className="LeftContent">
                      <p className="SummaryContentTitle">
                        ...
                        <div className="col-md-8">
                          <p className="CategoryName">
                            <span className="CategoryTitle">
                              {this.props.SummaryDetails
                                .serviceRequestTypeVisits &&
                                this.props.SummaryDetails.serviceRequestTypeVisits.map(
                                  serviceType => {
                                    return (
                      ...
                      <div className="row CostTableWidget">
                        ...
                        <div className="col-md-4 CostTableContainer Cost">
                          <p>
                            <span>
                              {this.props.CalculationsData.totalChargableTime}{" "}
                              hrs
                            </span>
                            <span>
                              $
                          ...
                          <p className="TaxCost">
                            <span>
                              $
                              {parseFloat(
                                this.props.CalculationsData.totalVisitCost
                              ).toFixed(2)}
                            </span>
                            <span>
                              $
                              {parseFloat(
                                this.props.CalculationsData.taxes
                              ).toFixed(2)}
                            </span>
                          </p>
                        </div>
                        <div className="col-md-12 CostTableContainer Total">
                          ...
                          <p className="TotalCost">
                            <span>
                              $
                              {parseFloat(
                                this.props.CalculationsData.grandTotalAmount
                              ).toFixed(2)}
                            </span>
                          </p>
                        </div>
                        ...
                        <div className="row EstimatedCostWidget">
                          ...
                          <div className="col-md-4 EstimatedCostContainer Cost">
                            <p>
                              <span>
                                $
                                {this.props.SummaryDetails.estimatedClaim &&
                                  this.props.SummaryDetails.estimatedClaim}
                              </span>
                              <span>
                                $
                                {this.props.SummaryDetails.outOfPocketAmount &&
                                  this.props.SummaryDetails.outOfPocketAmount}
                              </span>
                            </p>
                          </div>
                      ...
                      <p className="DisclaimerText">
                        Disclaimer - I authorize this payment recognizing that
                        this claim is an estimate pending the claim process
                      </p>
                    </div>
                  </div>
                  <div className="RightWidget">
                    <div className="RightContent">
                      ...
                      <div
                        className="SignatureColumn"
                        onClick={this.onClickSignaturePad}
                      >
                        <SignaturePad ref={ref => (this.signaturePad = ref)} />
                      </div>
                      <div className="width100 text-right">
                        <button
                          className="btn btn-outline-primary CancelSignature"
                ...
                <div className="bottomButton">
                  <div className="ml-auto">
                    <a className="btn btn-primary" onClick={this.onClickNext}>
                      Proceed to Payment
                    </a>
                  </div>
                </div>
...
function mapStateToProps(state) {
  return {
    SummaryDetails:
      state.visitSelectionState.VisitServiceProcessingState.SummaryState
        .SummaryDetails,
    CalculationsData:
      state.visitSelectionState.VisitServiceProcessingState.SummaryState
        .CalculationsData,
