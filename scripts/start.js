...
if (argv.includes('--qa')) {
  ...
  process.env.REACT_APP_UI_URL = 'http://localhost:3001/';
  process.env.REACT_APP_MSG_URL = "http://localhost:63632/api/";
  process.env.REACT_APP_ES_URL = 'https://chqa-ui.coreoflowsandbox.com/api/';
  process.env.REACT_APP_TP_URL = 'http://localhost:63632/api/';
  process.env.REACT_APP_SIGNALR_URL = 'http://localhost:63632/api/';
