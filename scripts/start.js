...
process.env.REACT_APP_SR_URL = "http://localhost:5615/api/";
process.env.REACT_APP_UI_URL = 'http://localhost:3000/#/';
process.env.REACT_APP_MSG_URL = "http://localhost:63632/api/";
process.env.REACT_APP_ES_URL = 'http://localhost:5615/api/';
process.env.REACT_APP_TP_URL = 'http://localhost:63632/api/';
process.env.REACT_APP_SIGNALR_URL = 'http://localhost:63632/signalr';
